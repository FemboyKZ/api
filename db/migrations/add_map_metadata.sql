...
ADD COLUMN global_created_on DATETIME NULL COMMENT 'Creation timestamp from GlobalAPI',
ADD COLUMN global_updated_on DATETIME NULL COMMENT 'Last update timestamp from GlobalAPI';
...
ALTER TABLE kz_maps COMMENT = 'Normalized map data with GlobalAPI metadata';
