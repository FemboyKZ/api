...
describe("History Endpoints", () => {
  ...
  // Every history endpoint funnels a failed query into the same 500, differing only in the noun.
  describe("database failures", () => {
    it.each([
      ["/history/servers/192.168.1.1/27015", "Failed to fetch server history"],
      ["/history/players/76561198000000001", "Failed to fetch player history"],
      ["/history/maps", "Failed to fetch map history"],
      ["/history/trends/daily", "Failed to fetch daily trends"],
      ["/history/trends/hourly", "Failed to fetch hourly trends"],
